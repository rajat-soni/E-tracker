...
//console.log(senderlist);
        ...
        response.render('sender', {title : 'Sender Module',querysender:querysender,data: data,data1: data1,data2: data2,currentblast: currentblast,data4: data4,clientlist: clientlist,completed:completed,pending:pending,userlist:userlist,  session:request.session,missed:missed});
