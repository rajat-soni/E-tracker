...
$(document).ready(function () { // for fetch Data //
                ...
                $("#user_ebcomment").hide(); 
                   ...
                   var length = user_image1.length;
                      ...
                      { 
                         ...
                         htmlContent += '<p> <tr><td ><span>&nbsp; &nbsp;'+user_image1[i]+'<span>&nbsp; &nbsp;<button type="button" class="btn btn-primary"  name="webinar_files" id="images" onclick="fileviewFunction(this)" data-id=\''+data.camp_id+ ',' + user_image1[i] + ',' + i +  ','  + tact+'\'>Download</button></td></tr>' ,'</p>' ;
                      }
               ...
               // $("#rbFlex").show();
                ...
                var htmlebContent = '';
                   ...
                   { 
                      ...
                      htmlebContent += '<p> <tr><td><span>&nbsp; &nbsp;'+user_image[i]+'&nbsp;&nbsp;</span><button type="button" class=" btn btn-primary btn-sm bg-primary btn-sm"  name="user_ebfiles" style = "font-size: 12px;" id="user_ebfiles" onclick="fileviewFunction(this)" data-id=\''+ data.cate_id +','+user_image[i]+',' + i +  ','  + tact +'\'> Download</button></td></tr>' ,'</p>' ;
                   }
                  ...
                  // $("#rbFlex").show();
                   ...
                   var user_rbfiles_length = user_rbfiles.length;
                      ...
                      { 
                         ...
                         htmlContent += '<tr><td ><p> <span>&nbsp; &nbsp;'+user_rbfiles[i]+'&nbsp;&nbsp;</span><button type="button" class="btn btn-primary btn-sm"  name="user_rbfiles" style = "font-size: 12px;" id="user_file" onclick="fileviewFunction(this)" data-id=\''+data.camp_id+ ',' + user_rbfiles[i] + ',' + i +  ','  + tact+'\'>Download</button></td></tr>' ,'</p>';
                 ...
                 if(tactValue==="Email-Blast")  
                 {
                   ...
                   for (var i = 0; i <= length; i++){ 
                         ...
                         if(user_imagename[i] == undefined) { 
                            ...
                            htmlContent += '<p> <tr><td width="60%"><span>&nbsp; &nbsp;'+user_imagename[i]+'&nbsp;&nbsp;</span><button type="button" class=" btn btn-primary btn-sm bg-primary"  name="image" id="image" onclick="fileviewFunction(this)" data-id=\''+ cate_id +','+user_imagename[i]+',' + i +  ','  + tactValue +'\'> Download File</button></td> &nbsp;<td  width="40%"><input type="text" value='+user_imagename[i]+' name="filenum" style="display:none;"> <span> &nbsp; &nbsp;<input type="submit" class="btn btn-danger btn-sm  " onclick = "fileReplace1(this)"  data-id=\'' + data.camp_id + ','+user_imagename[i]+',' + i + ',' +tactValue+'\' value = "Delete Files"> &nbsp; &nbsp;</span></td><td></tr></td>' ,'</p>';
                         }else{
                   ...
                   if (2 - length > 0) {
                            ...
                            htmlContent += '<form enctype="multipart/form-data" id = "form_id"><p> <tr id = "tr_id"><td><input type = "file" class="form-control" name = "image" id = "hello"    data-id="'+data.camp_id+'" ></td><td><button type="button" class="imageform btn btn-primary" onclick="myFunction(this)" data-id='+ data.camp_id + ','+tactValue+'>Insert Files</button></td></tr>' ,'</p>  </form>';
 ...
 (user_rb_files[i] != ''){
                   ...
                   htmlContent += '<p class="main"> <tr><td width="60%"><span>&nbsp; &nbsp;'+user_rb_files[i]+'&nbsp;&nbsp;</span><button type="button" class=" btn btn-primary btn-sm bg-primary"  name="image" id="image" onclick="fileviewFunction(this)" data-id=\''+ data.camp_id +','+user_rb_files[i]+',' + i +  ','  + tactValue +'\'> Download</button></td> &nbsp;</td><td width="40%"> <input type="submit" class="btn btn-danger btn-sm bg-danger" onclick = "fileReplace1(this)" data-id=\'' + data.camp_id + ','+user_rb_files[i]+',' + i + ',' +tactValue+'\' value = "Delete file" id = "btn_id"></td> </tr>' ,'</p>' ;
 ...
 //   alert("webinarFiles length" +length)
    ...
    for (var i = 0; i <= 1; i++){ 
       ...
       }else  if(user_imagename[i] != '')
       {
          ...
          console.log("Within else condition...");
          console.log(user_imagename[i]);
          htmlContent += '<p> <tr><td width="60%"><span>&nbsp; &nbsp;'+user_imagename[i]+'&nbsp;&nbsp;</span><button type="button" class=" btn btn-primary btn-sm bg-primary"  name="image" id="image" onclick="fileviewFunction(this)" data-id=\''+ data.camp_id +','+user_imagename[i]+',' + i +  ','  + tactValue +'\'> Download</button></td > &nbsp;<td  width="40%"><input type="text" value='+user_imagename[i]+' name="filenum" style="display:none;"> <span> &nbsp; &nbsp;<input type="submit" class="btn btn-danger btn-sm  " onclick = "fileReplace1(this)"  data-id=\'' + data.camp_id + ','+user_imagename[i]+',' + i + ',' +tactValue+'\' value = "Delete Files"> &nbsp; &nbsp;</span></tr></td></tr>' ,'</p>';
          ...
          alert("please check the data webinardata!")
             ...
             htmlContent += '<form enctype="multipart/form-data" id = "form_id"><p> <tr id = "tr_id"><td><input type = "file" class="form-control" name = "image"   id = "hello"  data-id="'+data.camp_id+'" ></td><td><button type="button" class="imageform btn btn-primary" onclick="myFunction(this)" data-id='+ data.camp_id + ','+tactValue+'>Send Comment</button></td></tr>' ,'</p>  </form>';
 ...
 $(document).on('click', '.remider_blstcheckbox', function (e) {
    ...
    function myFunction(e) { //=> funtion for uploading images into data base //   
        ...
        alert("webianrhieght"+imageleng)
 
     if(imageleng==0){
       alert("file not be empty!")
